...
const skills = [
  ...
  { 
    ...
    icon: <FileJson />, 
    technologies: ['RESTful APIs', 'GraphQL', 'Swagger']
  },
]
...
const Footer = ({ language }) => {
  ...
  return (
    <footer className="bg-slate-900 text-center py-6 mt-20 flex flex-col items-center justify-center relative z-10">
      <p className="text-slate-400">&copy; {year} Jane Doe. {translations[language].allRightsReserved}</p>
...
export default function Component() {
  ...
  return (
    <div className="bg-gradient-to-br from-slate-900 to-slate-800 text-slate-300 min-h-screen relative">
      <AnimatedBackground />
      <motion.div
      ...
      <Section id="home">
        <div className="text-center">
          <motion.div
            ...
            className="mb-8 relative w-48 h-48 mx-auto rounded-full overflow-hidden border-4 border-orange-500 shadow-lg"
          >
            <Image
              src={Profile}
              alt="Profile picture"
      ...
      <Section id="about">
        ...
        >
          <p className="text-xl text-slate-300 mb-6">
            I'm a passionate Backend Developer with a focus on automation workflows and database management. With extensive experience in Python, JavaScript, and MySQL, I specialize in creating efficient, scalable, and robust backend solutions.
          </p>
          <p className="text-xl text-slate-300">
            My expertise lies in developing automation workflows using tools like n8n, optimizing database performance, and building RESTful APIs. I'm dedicated to streamlining processes and enhancing productivity through innovative backend solutions.
          </p>
        </motion.div>
      </Section>
      ...
      <Section id="skills">
        ...
        >
          <p className="text-xl text-slate-400">
            Specializing in backend development and automation, I create efficient and scalable solutions to streamline workflows and enhance productivity.
          </p>
        </motion.div>
      </Section>
      ...
      <Section id="projects">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project, index) => (
            ...
            >
              <Image src={project.image} alt={project.name} width={300} height={200} className="w-full h-48 object-cover" />
              <div className="p-6">
